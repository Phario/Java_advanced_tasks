...
public class QuestionBuilder implements IQuestionBuilder {
    ...
    private Question createHeightQuestion() {
        ...
        String answerKey;
        int height = Integer.parseInt(character.height());
    ...
    private Question createStarshipQuestion() {
        ...
        String answerKey;
        int crew = Integer.parseInt(starship.crewCapacity().replaceAll("\\p{Punct}", ""));
    ...
    private Question createPlanetQuestion() {
        ...
        String answerKey;
        int rotation = Integer.parseInt(planet.rotationPeriod());
