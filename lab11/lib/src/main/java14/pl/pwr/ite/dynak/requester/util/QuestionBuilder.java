...
public class QuestionBuilder implements IQuestionBuilder {
    ...
    public Question getQuestion() {
        ...
        switch (randomInt) {
            case 0 -> question = createHeightQuestion();
            case 1 -> question = createStarshipQuestion();
            case 2 -> question = createPlanetQuestion();
            default -> throw new IllegalStateException("Invalid question type generated");
        }
    ...
    private Question createHeightQuestion() {
        ...
        int genderNum = switch (character.getGender().toLowerCase()) {
            case "male" -> 0;
            case "female" -> 1;
            default -> 2;
        };
